...
<!-- Check if admin has signed in -->
<?php if(isset($_SESSION['ADMIN'])) header("location: ./dashboard.php"); ?>
                ...
                <div class="min-h-screen h-full flex flex-col after:flex-1">
                    ...
                    <div class="max-w-sm mx-auto px-4 py-8">
                        ...
                        <form action="./handlers/auth_handler.php" method="post">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input id="password" class="form-input w-full" type="password" autocomplete="on" name="password" />
                                </div>
                            </div>
                            <div class="flex items-center justify-between mt-6">
                                <div class="mr-1">
                                    <a class="text-sm underline hover:no-underline" href="reset-password.html">Forgot Password?</a></div>
                                    <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3" name="login">Sign In</button>
                            </div>
                        </form>
                        <div class="pt-5 mt-6 border-t border-gray-200">
                            ...
                            <div class="mt-5">
                                <div class="bg-yellow-100 text-yellow-600 px-3 py-2 rounded"><svg class="inline w-3 h-3 shrink-0 fill-current" viewBox="0 0 12 12">
                                        <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
                                    </svg> <span class="text-sm">To support you during the pandemic super pro features are free until March 31st.</span></div>
                            </div>
                        </div>
                    </div>
                </div>
