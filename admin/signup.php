                        ...
                        <form action="./handlers/auth_handler.php" method="post">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input id="name" class="form-input w-full" name="name" />
                                </div>
                            ...
                            <div class="flex items-center justify-between mt-6">
                                ...
                                <button name="signup" class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3 whitespace-nowrap" >Sign Up</button>
                            </div>
                        </form>

                        <div class="pt-5 mt-6 border-t border-gray-200">
                            <div class="text-sm">Have an account? 
                                <a class="font-medium text-indigo-500 hover:text-indigo-600" href="index.php">Sign In</a>
                            </div>
                        </div>
                    </div>
                </div>
